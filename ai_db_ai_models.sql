...
CREATE TABLE `ai_models` (
  ...
  `epsilon` float NOT NULL DEFAULT '1',
  `total_games` int NOT NULL DEFAULT '0',
  `wins` int NOT NULL DEFAULT '0',
  `losses` int NOT NULL DEFAULT '0',
  `average_reward` double NOT NULL DEFAULT '0',
...
INSERT INTO `ai_models` VALUES (1,1,'models/dqn_model.bin',29167,0.74741,249,0,0,0.387862,'2026-08-28 04:59:04','2026-08-31 02:33:15');
...
-- Dump completed on 2026-09-04  0:56:18
